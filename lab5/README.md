...
2. [Пошук надлишковості та аномалій]()
    
3. [Перелік функціональних залежностей (ФЗ)]()
    
4. [Перевірка нормальних форм]()
    
5. [Застосування нормалізації]()
    
6. [Перероблений дизайн таблиць (ALTER TABLE)]()
